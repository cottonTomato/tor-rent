  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
          <h1 className="text-6xl font-bold mb-8 max-w-4xl mx-auto">
            The Future of Rental Agreements is Here
          </h1>
          <h2 className="text-xl mb-10">
            Secure, automated, and transparent rental transactions powered by
      ...
      <div className="flex justify-center space-x-4">
        ...
        <a
          href="/login"
          className="border text-white border-white py-3 px-6 rounded-md hover:bg-white/10 transition duration-300"
        >
          Already a user?
        </a>
      </div>
